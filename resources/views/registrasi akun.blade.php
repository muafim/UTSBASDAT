...
<body class="bg-gray-100 flex justify-center items-center min-h-screen">
    <div class="bg-white rounded-lg p-10 shadow-lg w-full max-w-md text-center">
        ...
        <form class="space-y-4" method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                <input type="text" name="nama_akun" placeholder="Nama Akun" required class="w-full p-3 border border-gray-300 rounded focus:outline-none focus:border-blue-500" value="{{ old('nama_akun') }}">
            </div>
            <div class="form-group">
